...
const Footer = () => {
    const [footerData, setFooterData] = useState({
        ...
        google_maps_url: 'https://www.google.com/maps/place/Hanoi,+Vietnam',
        facebook_url: '#',
        instagram_url: '#',
        twitter_url: '#'
    });
                ...
                <div className="footer-content">
                    <div className="footer-section">
                        ...
                        <div className="footer-social">
                            <a href={footerData.facebook_url} className="social-icon" aria-label="Facebook">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                </svg>
                            </a>
                            <a href={footerData.instagram_url} className="social-icon" aria-label="Instagram">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href={footerData.twitter_url} className="social-icon" aria-label="Twitter">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="footer-links-grid">
                        ...
                        <div className="footer-column">
                            <h4>Liên hệ</h4>
                            <ul>
                                <li><a href={`tel:${footerData.phone.replace(/\s/g, '')}`}>📞 {footerData.phone}</a></li>
                                <li><a href={`mailto:${footerData.email}`}>✉️ {footerData.email}</a></li>
                                <li>
                                    <a
